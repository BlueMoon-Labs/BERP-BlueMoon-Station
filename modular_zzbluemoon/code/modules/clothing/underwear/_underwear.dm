...
/obj/item/clothing/underwear
	...
	icon = 'modular_zzbluemoon/icons/mob/clothing/underwear.dmi' //if someone is willing to make proper inventory sprites that'd be very cash money
	worn_icon = 'modular_zzbluemoon/icons/mob/clothing/underwear.dmi'
	worn_icon_digi = 'modular_zzbluemoon/icons/mob/clothing/underwear_digi.dmi'
