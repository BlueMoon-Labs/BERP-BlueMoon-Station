GLOBAL_LIST_INIT(brap_noises, list(
			'modular_zzbluemoon/sound/voice/farts/fart.ogg',
			'modular_zzbluemoon/sound/voice/farts/fart1.ogg',
			'modular_zzbluemoon/sound/voice/farts/fart2.ogg',
			'modular_zzbluemoon/sound/voice/farts/fart3.ogg',
			'modular_zzbluemoon/sound/voice/farts/fart4.ogg',
			'modular_zzbluemoon/sound/voice/farts/fart5.ogg',
			'modular_zzbluemoon/sound/voice/farts/fart6.ogg',
			'modular_zzbluemoon/sound/voice/farts/fart7.ogg',
			'modular_zzbluemoon/sound/voice/farts/fart8.ogg'
			))
