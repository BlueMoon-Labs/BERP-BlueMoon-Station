...
#define TOTAL_LAYERS 47 // SKYRAT EDIT CHANGE - ORIGINAL: 35 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 41
/// Mutations layer - Tk headglows, cold resistance glow, etc
#define MUTATIONS_LAYER 47 // SKYRAT EDIT CHANGE - ORIGINAL: 35  // BLUEMOON EDIT: Extra inventory - ORIGINAL: 41
/// Mutantrace features (tail when looking south) that must appear behind the body parts
#define BODY_BEHIND_LAYER 46 // SKYRAT EDIT CHANGE - ORIGINAL: 34  // BLUEMOON EDIT: Extra inventory - ORIGINAL: 40
/// Layer for bodyparts that should appear behind every other bodypart - Mostly, legs when facing WEST or EAST
#define BODYPARTS_LOW_LAYER 45 // SKYRAT EDIT CHANGE - ORIGINAL: 33  // BLUEMOON EDIT: Extra inventory - ORIGINAL: 39
/// Layer for most bodyparts, appears above BODYPARTS_LOW_LAYER and below BODYPARTS_HIGH_LAYER
#define BODYPARTS_LAYER 44 // SKYRAT EDIT CHANGE - ORIGINAL: 32  // BLUEMOON EDIT: Extra inventory - ORIGINAL: 38
/// Mutantrace features (snout, body markings) that must appear above the body parts
#define BODY_ADJ_LAYER 43 // SKYRAT EDIT CHANGE - ORIGINAL: 31  // BLUEMOON EDIT: Extra inventory - ORIGINAL: 37
/// Underwear, undershirts, socks, eyes, lips(makeup)
#define BODY_LAYER 42 // SKYRAT EDIT CHANGE - ORIGINAL: 30  // BLUEMOON EDIT: Extra inventory - ORIGINAL: 36
// BLUEMOON EDIT START:  Extra inventory
...
#define FRONT_MUTATIONS_LAYER 37 // SKYRAT EDIT CHANGE - ORIGINAL: 29 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 35
/// Damage indicators (cuts and burns)
#define DAMAGE_LAYER 36 // SKYRAT EDIT CHANGE - ORIGINAL: 28 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 34
// SKYRAT EDIT ADDITION START
/// This layer is used for things that shouldn't be over clothes, but should be over mutations
#define BODY_FRONT_UNDER_CLOTHES 35 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 33
// SKYRAT EDIT ADDITION END
/// Jumpsuit clothing layer
#define UNIFORM_LAYER 34 // SKYRAT EDIT CHANGE - ORIGINAL: 27 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 32
// SKYRAT EDIT ADDITION BEGIN - cursed layers under clothing
#define ANUS_LAYER 33 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 31
#define VAGINA_LAYER 32 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 30
#define PENIS_LAYER 31 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 29
#define NIPPLES_LAYER 30 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 28
#define BANDAGE_LAYER 29 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 27
//SKYRAT EDIT ADDITION END
/// ID card layer
#define ID_LAYER 28 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 26
/// ID card layer (might be deprecated)
#define ID_CARD_LAYER 27 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 25
/// Layer for bodyparts that should appear above every other bodypart - Currently only used for hands
#define BODYPARTS_HIGH_LAYER 26 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 24
/// Gloves layer
#define GLOVES_LAYER 25 // BLUEMOON EDIT: Extra inventory - ORIGINAL: 22
/// Wrists layer
#define WRISTS_LAYER 24 // BLUEMOON EDIT: Extra inventory
/// Shoes layer
